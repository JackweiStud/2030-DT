...
- case2 Gate 1 已于 2026-07-30 经用户视觉审阅冻结；Gate 1.5 静态 HTML 已由用户人工检查接受；Gate 2 API 契约 v1 已于 2026-07-31 获用户批准。Gate 3 演示向放宽与 `WEB-SPEC` / `SERVER-SPEC` 已于 2026-08-03 定稿，进入 Gate 4。模拟后端打桩规格见 `doc/case2/realback_no.md`（与适配服务分离）。
