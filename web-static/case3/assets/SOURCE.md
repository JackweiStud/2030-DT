...
本目录文件仅供 Pencil Gate 1 设计输入，**不是**正式运行资源。
...
| `bg-*.png` | `02-ux/case3/` 背景切图 |
| `icon-cost-thrp.png` / `icon-predict.png` / `ring-accuracy.png` | `02-ux/case3/下部分/元素/` |
| `video-*.png` | 自 case2 Shell 弹窗资产复制，供 site-env-modal |

正式 Web 运行前应同步到 `04-runtime-assets/case3/`，禁止 React 直接引用 `02-ux/`。
