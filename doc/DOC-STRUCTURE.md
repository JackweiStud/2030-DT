...
| `doc/case2/`（已启动） | case2 主线、UX 状态、设计分析/计划、设计冻结、静态验收、case2 契约、SPEC、QA | 其他 case 的业务细节 |
...
- case2 已进入 Gate 1，因此只创建了 `MAINLINE.md`、`UX-STATE-MAP.md`、`Design_Analysis.md` 与 `Pen_Plan.md`；尚未创建 case2 API、SPEC、QA 空文档。
