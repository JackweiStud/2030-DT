...
| `doc/case2/`（已启动） | case2 主线、UX 状态、设计分析/计划、设计冻结、静态验收、UI 数据来源反查、SPEC、QA | 其他 case 的业务细节 |
...
| `doc/API-CONTRACT-REVIEW.md`（Gate 2） | 契约中的修/跳/待确认与 Gate 2 批准条件 | 具体 Node/React 实现方案 |
...
- case2 已进入 Gate 2，因此创建了 `doc/API-CONTRACT.md`、`doc/API-CONTRACT-REVIEW.md` 与 `doc/case2/UI-DATA-SOURCE-MAP.md`；尚未创建 Gate 3 SPEC 或 QA 文档。
