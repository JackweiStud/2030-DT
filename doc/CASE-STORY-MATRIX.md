...
| case3 | DT for Comm | 2 | Without DT 先跑通信基线，With DT 再跑数字孪生辅助通信，并对比 Cost、Throughput 与 Beam Accuracy | 独立业务 case；复用 Shell/Node 适配骨架和截图机制，不复用 case2 指标语义 | Gate 1 已冻结；Gate 1.5 已接受；Gate 2 v1 已批准；三份 Gate 3 SPEC `REVIEW_READY`，待用户批准 | `doc/case3/` |
